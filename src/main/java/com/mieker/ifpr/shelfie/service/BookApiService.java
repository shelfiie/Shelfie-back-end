...
public class BookApiService {
    ...
    public BookDTO setBook(BookApiResponse response) {
        ...
        if (response.getVolumeInfo().getImageLinks() == null) {
            book.setSmallThumbnailUrl("https://centrodametropole.fflch.usp.br/sites/centrodametropole.fflch.usp.br/files/user_files/livros/imagem/capa-no-book-cover.png");
            book.setThumbnailUrl("https://centrodametropole.fflch.usp.br/sites/centrodametropole.fflch.usp.br/files/user_files/livros/imagem/capa-no-book-cover.png");
        } else {
